...
namespace StardewModdingAPI
{
    ...
    public static class Constants
    {
        ...
        ****/
        ...
        public static ISemanticVersion ApiVersion { get; } = new SemanticVersion("2.6-beta.14");

        /// <summary>The minimum supported version of Stardew Valley.</summary>
        public static ISemanticVersion MinimumGameVersion { get; } = new GameVersion("1.3.11");
